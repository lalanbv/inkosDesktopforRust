...
const strings = {
  ...
  "dash.backfillEntry": { zh: "回填设定", en: "Backfill settings" },
  ...
  "timeline.editTimeline": { zh: "编辑时间线", en: "Edit Timeline" },
  "timeline.editBeat": { zh: "编辑节拍", en: "Edit Beat" },
  "timeline.beatTitle": { zh: "节拍标题", en: "Beat title" },
  "timeline.beatNote": { zh: "备注", en: "Note" },
  "timeline.openChapter": { zh: "打开章节", en: "Open chapter" },
  "timeline.save": { zh: "保存", en: "Save" },
  "timeline.saving": { zh: "保存中…", en: "Saving…" },
  "timeline.saveFailed": { zh: "保存失败：{message}", en: "Save failed: {message}" },
  "timeline.cancel": { zh: "取消", en: "Cancel" },
  "timeline.addBeat": { zh: "添加节拍", en: "Add beat" },
  "timeline.addPlotline": { zh: "+ 添加情节线", en: "+ Add plotline" },
  "timeline.plotlineName": { zh: "情节线名称", en: "Plotline name" },
  "timeline.confirmAdd": { zh: "添加", en: "Add" },
  "backfill.hint": { zh: "从系列已有书抽取设定（世界观/人物/情节/文风），预览勾选后写入新书（story/series_backfill.md，不碰既有真相文件）。", en: "Extract settings from an existing series book (worldview/characters/plot/style), preview, then write selected items into the new book (story/series_backfill.md; existing truth files are untouched)." },
  "backfill.selectSource": { zh: "选择源书（已有设定）", en: "Select source book (with settings)" },
  "backfill.selectTarget": { zh: "选择目标书（新书）", en: "Select target book (new book)" },
  "backfill.extract": { zh: "抽取设定", en: "Extract Settings" },
  "backfill.extracting": { zh: "抽取中（LLM 摘要，约几十秒）…", en: "Extracting (LLM summary, ~tens of seconds)…" },
  "backfill.preview": { zh: "抽取结果 · {n} 条（勾选要回填的设定）", en: "Extracted · {n} items (check the ones to backfill)" },
  "backfill.selectAll": { zh: "全选", en: "Select all" },
  "backfill.deselectAll": { zh: "取消全选", en: "Deselect all" },
  ...
  "backfill.diffHint": { zh: "diff 预览按所选写入粒度实时联动（上方红/绿行）。", en: "The diff preview updates live with the selected write mode (red/green lines above)." },
  "backfill.modeLabel": { zh: "写入粒度", en: "Write mode" },
  "backfill.modeOverwrite": { zh: "整体覆盖", en: "Overwrite" },
  "backfill.modeMerge": { zh: "合并追加", en: "Merge & append" },
  "backfill.modeOverwriteHint": { zh: "文件重写为勾选条目（未勾选的既有条目被移除）。", en: "File is rewritten to the selected items (unchecked existing items are removed)." },
  "backfill.modeMergeHint": { zh: "保留既有条目，勾选项按类目+标题去重后追加（不覆盖旧内容）。", en: "Keeps existing items and appends the selection, deduped by category + title (old content is kept)." },
  ...
  "backfill.category.worldview": { zh: "世界观", en: "Worldview" },
  "backfill.category.character": { zh: "人物", en: "Characters" },
  "backfill.category.plot": { zh: "情节", en: "Plot" },
  "backfill.category.style": { zh: "文风", en: "Style" },
  "backfill.category.faction": { zh: "势力组织", en: "Factions" },
  "backfill.category.item": { zh: "关键物品", en: "Key Items" },
  "backfill.category.location": { zh: "重要地点", en: "Locations" },
  "backfill.category.other": { zh: "其他", en: "Other" },
  "nav.import.backfill": { zh: "导入：系列书回填", en: "Import: Series Backfill" },
  "timeline.rename": { zh: "重命名", en: "Rename" },
  "timeline.renamePlotline": { zh: "重命名情节线", en: "Rename plotline" },
  "timeline.remove": { zh: "删除", en: "Delete" },
  "timeline.removePlotline": { zh: "删除情节线（连其全部节拍）", en: "Delete plotline (with all beats)" },
  "timeline.removeConfirm": { zh: "确认删除?", en: "Confirm delete?" },
  "timeline.writeFromBeat": { zh: "按此节拍写下一章", en: "Write next chapter from this beat" },
  "timeline.writeStarted": { zh: "已在后台按节拍写作，完成后本页自动刷新。", en: "Background writing started from this beat. This page refreshes when it finishes." },
  ...
  "reader.split": { zh: "对照分屏", en: "Split Compare" },
  "reader.splitClose": { zh: "关闭对照", en: "Close Compare" },
  "reader.compareChapter": { zh: "对照章", en: "Compare" },
  "reader.splitPrev": { zh: "上一章", en: "Previous chapter" },
  "reader.splitNext": { zh: "下一章", en: "Next chapter" },
  "reader.splitPlaceholder": { zh: "输入章号或点 › 开始对照阅读", en: "Enter a chapter # or press › to compare" },
  "reader.splitLoadFailed": { zh: "对照章加载失败", en: "Failed to load compare chapter" },
  ...
  // 207 号：章节状态全集 i18n——state-degraded 曾以原始枚举大写暴露。
  "chapter.stateDegraded": { zh: "状态降级", en: "State Degraded" },
  "chapter.cardGenerated": { zh: "卡片已生成", en: "Card Generated" },
  "chapter.drafting": { zh: "撰写中", en: "Drafting" },
  "chapter.auditing": { zh: "审计中", en: "Auditing" },
  "chapter.auditPassed": { zh: "审计通过", en: "Audit Passed" },
  "chapter.revising": { zh: "修订中", en: "Revising" },
  "chapter.rejected": { zh: "已驳回", en: "Rejected" },
